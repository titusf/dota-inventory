...
foreach ($results as $result) {
    ...
    if (isset($json_decoded->success)) {
        if ($json_decoded->success) {
            ...
            echo $item_name . " is currently worth " . $json_decoded->median_price . "-------  <br />";
            $stmt->execute();
        }
    }
}
//$j = file_get_contents("http://steamcommunity.com/market/priceoverview/?currency=3&appid=570&market_hash_name=Blue%20Stone%20Shoulder%20of%20the%20Voyager");
//$jd = json_decode($j, true);
//echo $jd['median_price'];
//echo rawurlencode("rune of the foreseer");